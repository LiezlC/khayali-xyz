...
export const atlasDoors: AtlasDoor[] = [
  { title: 'The Room That Remembers', description: 'Notes, fragments, and echoes that refused to be lost.', href: '/applets/art-mindfulness/memory-pattern-games/the-memory-loom/index.html', kind: 'memory · applet', colour: 'amber' },
  { title: 'The Machine Garden', description: 'Where code tends, grows, guesses, and sometimes dreams.', href: '/applets/art-mindfulness/mindfulness-sound/eco-link-cyber-druid-interface/index.html', kind: 'machine · garden', colour: 'emerald' },
  ...
  { title: 'Quiet Rooms', description: 'Space to pause, breathe, and be with your thoughts.', href: '/applets/art-mindfulness/mindfulness-sound/neon-rain-zen-walk/index.html', kind: 'stillness · sound', colour: 'blue' },
]
...
export const atlasTrails: { title: string; intro: string; colour: string; stops: AtlasStop[] }[] = [
  {
    ...
    stops: [
      { title: 'The Memory Loom', note: 'Weave what remains.', href: '/applets/art-mindfulness/memory-pattern-games/the-memory-loom/index.html' },
  ...
  },
  {
    ...
    stops: [
      { title: 'BitSoil Farm', note: 'Turn digital noise into fertile soil.', href: '/applets/art-mindfulness/farming-sim/bitsoil-farm-the-digital-detox/index.html' },
...
export const randomDoors = [
  ...
  '/applets/art-mindfulness/misc-toys/orbital-bistro-edge-of-the-void/index.html',
