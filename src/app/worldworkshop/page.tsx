...
export default async function WorldWorkshopPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-slate-900 to-purple-900">      {/* Hero Section */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {content.map((item) => (
            <Link
              ...
              key={item.slug}
              className="group relative p-6 bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 hover:border-indigo-500 transition-all duration-300 overflow-hidden"
            >
