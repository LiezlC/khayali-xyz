...
export default function SongExcavationPage() {
  return <div className="min-h-screen overflow-hidden">
    ...
    <section className="py-20 bg-gray-950/30"><div className="container mx-auto px-4">
    ...
    <section className="py-20 bg-gray-800/25 border-y border-gray-800"><div className="container mx-auto px-4">
    ...
    <section id="process" className="py-20"><div className="container mx-auto px-4">
