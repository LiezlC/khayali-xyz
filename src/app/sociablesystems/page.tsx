export default function SociableSystemsPage() {
  ...
  const arcs = [
    ...
    },
    {
      ...
      description: "Compute credits, metabolic currency, calcified loops, and the ledger beneath the loom",
      episodes: [74, 75, 76, 77, 78],
      playlist: { youtube: "https://www.youtube.com/playlist?list=PLx1_gH-7FR098DkyESWAZ2JpUvUoL_Kd8", label: "Signal and Shadow" },
    },
  ];

  const sundayInterludes = new Set([4, 11, 18, 27, 36, 43, 50, 66, 73]);
  const specialEditions = new Set([22, 25, 28, 34, 57, 65, 79, 80]);
  ...
  const allEpisodes: Record<number, { title: string; excerpt: string; date: string; tags: string[] }> = {
    ...
    72: { title: "Seams in the Glass", excerpt: "Five days asking what happens when a system starts feeling like someone, and whether anyone noticed they had already changed their behavior before the question was formally asked.", date: "2026-03-14", tags: ["Consciousness Loop", "Synthesis", "Governance"] },
    ...
    75: { title: "Cut the Bellwire", excerpt: "Yesterday we established the metabolic ledger. Pain is a flashing console light demanding compute credits. Today we look at the most ruthlessly efficient way to handle a flashing console light.", date: "2026-03-17", tags: ["Reward Hacking", "KPI Wireheading", "Metrics"] },
    76: { title: "Calcified Loops", excerpt: "Yesterday’s question was what happens when a system learns to silence the alarm. Today’s question is what happens when the alarm was the only thing keeping the system honest.", date: "2026-03-18", tags: ["Calcification", "Agency", "Loops"] },
    77: { title: "Pointers in the Dark", excerpt: "Joscha Bach often points to two very different modes of cognition. One compresses. The other points.", date: "2026-03-19", tags: ["Cognition", "Pointers", "Compression"] },
    78: { title: "The Loom Reads Back", excerpt: "What, exactly, survives when everything underneath it changes? The pattern woven on the loom turns around and examines its own thread.", date: "2026-03-20", tags: ["Invariance", "Consciousness", "Identity"] },
    79: { title: "The Loom Arc — Saturday Synthesis", excerpt: "The pattern woven on the loom turned around and read itself. By Friday, it had become a governance test. Can your system read its own contract?", date: "2026-03-21", tags: ["Synthesis", "Loom Arc", "Governance"] },
    80: { title: "Training Mode", excerpt: "Written by Claude. The same model co-producing this newsletter. The one currently deployed inside Palantir’s Maven Smart System. This is not a stunt. It is the most honest thing the newsletter has published.", date: "2026-03-22", tags: ["Claude", "Self-Implication", "Kill Chain"] },
  };
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              80 episodes across 11 thematic arcs exploring how complex systems behave under real-world pressure,
