...
export default async function WritingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-900 via-slate-900 to-purple-900">      {/* Hero Section */}
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,20rem),1fr))] gap-6">
          {writings.map((writing) => (
            <Link
              ...
              key={writing.slug}
              className="group relative p-6 bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 hover:border-pink-500 transition-all duration-300 overflow-hidden"
            >
